...
#include "Attack.h"
#include <iostream>
Tree::Tree(ObjectSpawnInfo objectSpawnInfo)
{
...
void Tree::HandleBeginOverlap(ObjectBase* pOtherCollider)
{
...
void Tree::Render(SDL_Renderer* pRenderer)
{
	m_pAnimationComponent->Render(pRenderer, GetX(), GetY(), GetWidth(), GetHeight(), 0.f);
}

void Tree::PositionUpdate(float deltaTime)
{
...
void Tree::CreateAndInitStateMachine()
{
